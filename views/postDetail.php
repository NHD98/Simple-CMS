    ...
    xhr.onreadystatechange = function() {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        if (result) {
          ...
          temp = `<li class='nav-item active'><a class='nav-link' href='editPost.php?id=${postID}'>Edit post </a> </li>
                  <li class='nav-item active'><a class='nav-link' href='../controller/Post/deletePost.php?id=${postID}'>Delete post </a> </li>` +
            temp;
